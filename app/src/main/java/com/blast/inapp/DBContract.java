...
final class DBContract {
    ...
    static final String SELECT_EMPLOYEE_WITH_EMPLOYER = "SELECT * " +
            "FROM " + Employee.TABLE_NAME + " ee INNER JOIN" +
            Employer.TABLE_NAME + " er " +
            "ON ee." + Employee.COLUMN_EMPLOYER_ID + " = er." +
            Employer._ID + " WHERE " +
            "ee." + Employee.COLUMN_FIRSTNAME + " like ? AND ee." +
            Employee.COLUMN_LASTNAME + " like ?";

    private DBContract(){}

    static class Employer implements BaseColumns{
        static final String TABLE_NAME = "employer";
        static final String COLUMN_NAME = "name";
        static final String COLUMN_DESCRIPTION = "description";
        static final String COLUMN_FOUNDED_DATE = "date";
    ...
    static class Employee implements BaseColumns{
        ...
        static final String COLUMN_EMPLOYER_ID = "employer_id";
        static final String COLUMN_JOB_DESCRIPTION = "job_description";
        static final String COLUMN_EMPLOYED_DATE = "employed_date";
